 ...
 * Contains curated foundational verses enriched with structured concepts, contexts,
 * emotional relevance, modern application, and interpretive cautions.
 */
export const BHAGAVAD_GITA_CORPUS: GitaShloka[] = [
  ...
  // 2. Equanimity in Ups and Downs (Emotional Volatility, Stress, Balance)
  {
    ...
    concepts: ['samatvam', 'emotional-equilibrium', 'unshakeable-center', 'feedback-vs-identity'],
    contexts: ['dealing with setbacks', 'fear of rejection', 'unpredictable outcomes', 'mood swings', 'market crash', 'bad news'],
    emotional_relevance: ['anxious', 'restless', 'volatile', 'frustrated', 'stressed', 'insecure', 'uneasy'],
    modern_application: ['treating life highs and lows as natural seasonal cycles rather than definitions of self-worth'],
    caution: ['equanimity is not emotional suppression; it is grounded clarity that allows emotions to settle naturally'],
  ...
  // 3. Eternal Soul & Bereavement (Grief, Death, Loss of Loved Ones)
  {
    ...
    concepts: ['atman', 'eternal-consciousness', 'transcendence-of-physical-form', 'spiritual-continuity'],
    contexts: ['death of grandmother', 'death of grandfather', 'loss of parent', 'loss of loved one', 'funeral', 'passing away'],
    emotional_relevance: ['grieving', 'heartbroken', 'crying', 'devastated', 'hopeless', 'mourning', 'bereaved', 'lonely'],
    modern_application: ['honoring memories and eternal love without believing the human bond has dissolved into nothingness'],
    caution: ['do not use spiritual immortality to invalidate genuine human sorrow; grief must be held with gentleness'],
  ...
  // 4. Impermanence of Pleasure and Pain (Grief, Hard Times, Resilience)
  {
    ...
    concepts: ['titiksha', 'forbearance', 'transience', 'anitya', 'emotional-resilience'],
    contexts: ['loss of loved one', 'breakup', 'period of hardship', 'feeling down', 'chronic struggle', 'divorce'],
    emotional_relevance: ['sad', 'grieving', 'hopeless', 'suffering', 'heartbroken', 'discouraged', 'weary', 'down'],
    modern_application: ['remembering that emotional pain moves in temporary waves, allowing yourself to endure without panic'],
    caution: ['titiksha is patient endurance with self-compassion, not cold endurance or bottling up pain'],
  ...
  // 5. Overcoming Anger and Mental Chaos (Anger, Resentment, Rage)
  {
    ...
    concepts: ['buddhi-loss', 'krodha-delusion', 'pause-before-reaction', 'emotional-regulation'],
    contexts: ['heated arguments', 'fight with spouse', 'fight with partner', 'conflict with family', 'road rage', 'saying things you regret'],
    emotional_relevance: ['angry', 'furious', 'resentful', 'irritated', 'agitated', 'bitter', 'regretful'],
    modern_application: ['instituting a conscious pause when provoked so higher discernment rather than anger dictates decisions'],
    caution: ['healthy anger signals crossed boundaries; the danger is reactive rage that blinds logical reasoning'],
  ...
  // 6. Living One’s Own Authentic Calling / Svadharma (Career Dilemma, Purpose, Life Path)
  {
    id: 'BG3.35',
    chapter: 3,
    ...
    contexts: [
      ...
      'performing one’s own duty',
      'confusion about life direction',
      'career crossroads',
      'feeling pressured by external expectations',
      'working hard without feeling purpose'
    ],
    emotional_relevance: [
      'confusion',
      'uncertainty',
    ...
    modern_application: [
      'finding your path without demanding immediate certainty',
      'reflecting on one’s own direction rather than adopting someone else’s script',
      'examining what work feels genuinely yours before making big decisions'
    ],
    caution: [
      'do not interpret as simply doing whatever one personally prefers; it refers to one’s innate duty aligned with nature and ethical responsibility'
    ],
    emotions: ['lost', 'unfulfilled', 'jealous', 'envious', 'confused', 'insecure', 'empty', 'stuck', 'uncertain'],
    situations: [
      'which path to take in life',
      'confused about which path I should take in life',
  ...
  // 7. Overcoming Procrastination and Inertia (Discipline, Laziness)
  {
    ...
    concepts: ['action-over-inaction', 'momentum-first', 'micro-stepping', 'dissolving-inertia'],
    contexts: ['delaying important work', 'starting a healthy habit', 'breaking inertia', 'daily routine', 'studying', 'exercising'],
    emotional_relevance: ['lazy', 'procrastinating', 'paralyzed', 'hesitant', 'stuck', 'unmotivated', 'sluggish'],
    modern_application: ['initiating action with a 2-minute micro-step to break paralysis rather than waiting for mood'],
    caution: ['action should be aligned and deliberate, not reckless frenzy just to feel busy'],
  ...
  // 8. Spiritual Doubts & Faith (Sacred Knowledge vs Cynical Nihilism)
  {
    id: 'BG4.40',
    chapter: 4,
    ...
    author: 'Swami Gambhirananda',
    meaning:
      'Cynical skepticism toward sacred knowledge and moral truth robs the mind of peace. Sincere conviction (Shraddha) is essential to discover higher wisdom.',
    coreWisdom: 'Perpetual cynicism and faithlessness destroy inner joy; cultivate receptive conviction in truth.',
    themes: ['spiritual faith', 'shraddha', 'cynicism', 'epistemic doubt', 'sacred knowledge', 'faithless'],
    concepts: ['spiritual conviction', 'shraddha', 'samshaya', 'knowledge vs cynicism'],
    contexts: ['cynical skepticism toward spiritual knowledge', 'paralyzing distrust of truth', 'loss of faith in moral principles'],
    emotional_relevance: ['cynical', 'faithless', 'distrustful', 'nihilistic'],
    modern_application: ['recognizing when cynical doubt stops spiritual inquiry and cultivating healthy trust in higher wisdom'],
    caution: ['Do NOT apply to normal life-path dilemmas, career choices, or healthy vocational questioning; applies specifically to cynical skepticism toward spiritual knowledge and truth.'],
    emotions: ['cynical', 'faithless', 'distrustful', 'nihilistic'],
    situations: ['spiritual crisis of faith', 'cynicism toward wisdom', 'distrust of spiritual path'],
  },
  ...
  // 9. The Mind as Best Friend or Worst Enemy (Self-Mastery, Mental Health)
  {
    ...
    concepts: ['inner-ally', 'self-elevation', 'reframing-inner-critic', 'compassionate-mindset'],
    contexts: ['negative self-talk', 'recovering from mistakes', 'building self-respect', 'mental loneliness'],
    emotional_relevance: ['self-hating', 'depressed', 'worthless', 'insecure', 'discouraged', 'guilty', 'ashamed'],
    modern_application: ['shifting from harsh self-interrogation to becoming a patient, compassionate coach to yourself'],
    caution: ['self-compassion is not self-indulgence; it provides the psychological safety required for genuine accountability'],
  ...
  // 10. Calming the Restless Mind through Practice & Detachment (Meditation, ADHD/Distraction)
  {
    ...
    concepts: ['abhyasa', 'vairagya', 'patient-retraining', 'non-judgmental-focus'],
    contexts: ['struggling to meditate', 'cannot focus on study/work', 'doom-scrolling', 'overactive thoughts', 'ADHD symptoms'],
    emotional_relevance: ['restless', 'distracted', 'scattered', 'impatient', 'frustrated with focus'],
    modern_application: ['viewing meditation not as stopping thoughts, but as patiently bringing attention back each time it wanders'],
    caution: ['mind mastery requires months of gentle habituation, not forcible suppression'],
  ...
  // 11. Restless Wandering Mind (Bringing Mind Back Gently)
  {
    ...
    concepts: ['mindfulness-anchor', 'gentle-return', 'awareness-training', 'breath-anchor'],
    contexts: ['mind wandering during work', 'meditation practice', 'studying without retention'],
    emotional_relevance: ['distracted', 'unfocused', 'drifting', 'spacey', 'frustrated'],
    modern_application: ['cultivating an effortless return to current awareness whenever noticing cognitive drift'],
    caution: ['avoid self-chastisement when the mind drifts; frustration only adds further agitation'],
  ...
  // 12. The Steady Flame in a Windless Place (Deep Inner Peace, Presence)
  {
    ...
    concepts: ['unwavering-flame', 'sensory-silence', 'deep-centeredness', 'stillness'],
    contexts: ['seeking quiet time', 'evening reflection', 'meditation session', 'sensory detox'],
    emotional_relevance: ['overstimulated', 'anxious', 'craving peace', 'tired of noise', 'overwhelmed'],
    modern_application: ['carving out distraction-free spaces to allow cognitive agitation to burn still'],
    caution: ['silence must be practiced intentionally, not as escapism from responsibilities'],
  ...
  // 13. The Ocean Undisturbed by Incoming Rivers (Profound Stillness)
  {
    ...
    concepts: ['oceanic-depth', 'unmoved-peace', 'absorbing-demands', 'non-reactive-presence'],
    contexts: ['chaos at home or office', 'sensory overload', 'maintaining peace in crowds'],
    emotional_relevance: ['overwhelmed', 'bombarded', 'reactive', 'chaotic', 'seeking deep calm'],
    modern_application: ['remaining anchored in your inner foundation while allowing external demands to flow around you'],
    caution: ['depth of mind does not mean ignoring real danger; it means responding without panic'],
  ...
  // 14. Overcoming Fear of Failure and Judgment (Courage, Abhaya)
  {
    ...
    concepts: ['abhaya', 'fearless-duty', 'transcending-loss-and-gain', 'moral-courage'],
    contexts: ['facing a tough confrontation', 'taking a bold life risk', 'standing up for values', 'starting new venture'],
    emotional_relevance: ['afraid', 'fearful', 'intimidated', 'hesitant', 'scared of failure', 'anxious'],
    modern_application: ['making courageous ethical decisions without obsessing over whether the crowd applauds or boos'],
    caution: ['courage is deliberate action rooted in righteousness, not reckless gambling'],
  ...
  // 15. Compassion and Freedom from Malice in Relationships (Relationships, Forgiveness)
  {
    ...
    concepts: ['maitri', 'karuna', 'kshama', 'freedom-from-malice', 'softening-defensiveness'],
    contexts: ['relationship fight', 'friendship dispute', 'dealing with difficult colleagues', 'family conflict', 'spouse argument', 'marital dispute'],
    emotional_relevance: ['resentful', 'hurt', 'betrayed', 'bitter', 'vengeful', 'lonely', 'misunderstood', 'angry with partner'],
    modern_application: ['dropping the urge to retaliate in arguments and choosing mutual healing over winning debates'],
    caution: ['forgiveness is internal freedom from malice; it does not mean staying in abusive situations without boundaries'],
  ...
  // 16. Neither Agitating Others nor Being Agitated by the World (Social Peace, Boundaries)
  {
    ...
    concepts: ['calm-boundaries', 'non-reactivity', 'social-peace', 'emotional-maturity'],
    contexts: ['toxic environments', 'social media exhaustion', 'office politics', 'setting emotional boundaries', 'difficult in-laws'],
    emotional_relevance: ['annoyed', 'pressured by others', 'drained by drama', 'overly sensitive', 'irritated'],
    modern_application: ['maintaining unshakeable social poise and declining to participate in reactive drama'],
    caution: ['non-agitation does not mean being cold or indifferent; it means relating with centered calm'],
  ...
  // 17. What Appears like Poison First Tastes like Nectar at the End (Delayed Gratification)
  {
    ...
    concepts: ['sattvic-happiness', 'delayed-gratification', 'productive-friction', 'habit-formation'],
    contexts: ['exercising', 'studying for exams', 'quitting bad habits', 'deep focused work', 'sobriety'],
    emotional_relevance: ['unmotivated', 'craving comfort', 'tired', 'resisting effort', 'procrastinating'],
    modern_application: ['embracing the early discomfort of disciplined habits knowing it blooms into profound fulfillment'],
    caution: ['distinguish healthy discipline from self-harming punishment; true discipline nourishes the soul'],
  ...
  // 18. The Mind Free of Agitation Speaks Gentle Truth (Speech, Communication)
  {
    ...
    concepts: ['satya-priya-hitam', 'speech-austerity', 'non-injurious-words', 'beneficial-communication'],
    contexts: ['difficult conversations', 'giving feedback', 'resolving arguments', 'active listening', 'apologizing'],
    emotional_relevance: ['misunderstood', 'harsh', 'regretful of words', 'defensive', 'apologetic'],
    modern_application: ['filtering communication through truth, gentleness, and genuine benefit before speaking in anger'],
    caution: ['gentleness in speech must never sacrifice essential truth or moral clarity'],
  ...
  // 19. Divine Assurance & Overcoming Feeling Alone (Security, Protection)
  {
    ...
    concepts: ['yoga-kshema', 'divine-provision', 'universal-grace', 'spiritual-protection'],
    contexts: ['financial crisis', 'living alone', 'feeling unsupported', 'starting over from zero'],
    emotional_relevance: ['lonely', 'abandoned', 'scared', 'financially stressed', 'isolated', 'helpless'],
    modern_application: ['resting in the reassurance that sincere, honest effort is sustained by a higher cosmic order'],
    caution: ['grace supports effort; it is not an excuse for passivity or financial neglect'],
  ...
  // 20. Overcoming All Obstacles by Centered Awareness (Crisis, Resilience)
  {
    ...
    concepts: ['transcending-obstacles', 'surrender-of-ego', 'navigating-crises', 'centered-faith'],
    contexts: ['huge personal crisis', 'legal trouble', 'facing impossible challenge', 'family emergency'],
    emotional_relevance: ['trapped', 'hopeless', 'overwhelmed by problems', 'desperate', 'stuck'],
    modern_application: ['releasing egoic panic and taking the next principled step with quiet confidence'],
    caution: ['surrender is an internal realignment with wisdom, not abandoning practical steps'],
  ...
  // 21. Total Surrender of Anxiety and Fear (Despair, Surrender, Hope)
  {
    ...
    concepts: ['sharanagati', 'ultimate-surrender', 'release-of-anxiety', 'do-not-grieve', 'ma-shuchah'],
    contexts: ['rock bottom moments', 'facing insurmountable odds', 'deep burnout', 'existential fatigue'],
    emotional_relevance: ['exhausted', 'hopeless', 'grieving', 'defeated', 'overwhelmed to breaking point', 'crying'],
    modern_application: ['surrendering anxious striving when having exhausted human effort and resting in faith'],
    caution: ['surrender comes after giving your honest best; it is spiritual culmination, not avoidance'],
