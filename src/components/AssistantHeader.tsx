...
export const AssistantHeader: React.FC<AssistantHeaderProps> = ({
  ...
  return (
    <header className="h-14 border-b border-gray-200/80 bg-white/90 backdrop-blur-md px-4 flex items-center justify-between shrink-0 select-none">
      {/* Left: Assistant Branding without duplicate logo */}
      ...
      <div className="flex items-center gap-2">
        ...
        <div
          className="w-7 h-7 rounded-full bg-gray-900 text-white flex items-center justify-center text-xs ml-1 shadow-2xs select-none"
          title="User profile"
        >
          <User size={14} />
        </div>
